...
enum VoxelType {
  ...
  VOXEL_DOUBLE2 = vnr::VALUE_TYPE_DOUBLE2,
  VOXEL_DOUBLE3 = vnr::VALUE_TYPE_DOUBLE3,
  VOXEL_DOUBLE4 = vnr::VALUE_TYPE_DOUBLE4,
  VOXEL_VOID    = vnr::VALUE_TYPE_VOID,
};
} // namespace vidi
...
void
load_regular_grid(const VolumeDesc::File& desc,
...
// Regular Grid Loader ////////////////////////////////////////////////
OpenVKLSampler::OpenVKLSampler(const VolumeDesc::File& file, vec3i dims, dtype type, range1f range)
{
...
// regular grid
OpenVKLSampler_WithGroundTruthData::OpenVKLSampler_WithGroundTruthData(const VolumeDesc& desc)
...
OpenVKLSampler_WithGroundTruthData::OpenVKLSampler_WithGroundTruthData(const VolumeDesc& desc, const vec3i dims)
  : OpenVKLSampler(desc.data[0], desc.dims, desc.type, desc.range)
{
  m_dims = dims;
...
OutOfCoreSampler::OutOfCoreSampler(const VolumeDesc& desc)
{
  m_dims = desc.dims;
  m_type = desc.type;
...
VirtualMemorySampler::VirtualMemorySampler(const VolumeDesc& desc)
{
  m_dims = desc.dims;
  m_type = desc.type;
  m_value_range = desc.range;
